...
const API = axios.create({
  baseURL: "https://your-tube-vpzu.onrender.com", // use your backend URL here
});

// 🔐 Attach token to headers if user is logged in
...
export const likevideo = (id, Like) =>
  API.patch(`/video/like/${id}`, { Like });
